...
const uint32_t _p32_t[ROWS] = {0, 0, 0, 0, 0, 0, 0, 1, 2, 1, 5, 14, 6, 28, 48, 11, 91, 21, 151, 29, 115, 261, 356, 1022, 0, 1979, 
649,
...
const uint8_t _p8_t[ROWS] = {0, 0, 0, 15, 54, 90, 150, 96, 152, 230, 226, 90, 4, 82, 222, 246, 14, 64, 162, 196, 47, 149, 166, 
58, 
7,
...
//     srand(time(NULL));
    ...
    uint32_t cycles, cycles1, cycles2;
    uint32_t i;
